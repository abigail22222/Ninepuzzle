...
public class RegisterJFrame extends JFrame implements MouseListener {
    ...
    public void mouseClicked(MouseEvent e) {
        if(e.getSource() == submit){
            ...
            //6.写入文件
            FileUtil.writeLines(allUsers,"E:\\project\\Ninepuzzle\\puzzle\\userinfo.txt","UTF-8");
            //7.提示注册成功
            showDialog("注册成功");
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getSource() == submit) {
            submit.setIcon(new ImageIcon("puzzle\\image\\register\\注册按下.png"));
        } else if (e.getSource() == reset) {
            reset.setIcon(new ImageIcon("puzzle\\image\\register\\重置按下.png"));
        }
    }
    ...
    public void mouseReleased(MouseEvent e) {
        if (e.getSource() == submit) {
            submit.setIcon(new ImageIcon("puzzle\\image\\register\\注册按钮.png"));
        } else if (e.getSource() == reset) {
            reset.setIcon(new ImageIcon("puzzle\\image\\register\\重置按钮.png"));
        }
    }
    ...
    private void initView() {
        //添加注册用户名的文本
        JLabel usernameText = new JLabel(new ImageIcon("puzzle\\image\\register\\注册用户名.png"));
        ...
        //添加注册密码的文本
        JLabel passwordText = new JLabel(new ImageIcon("puzzle\\image\\register\\注册密码.png"));
        ...
        //添加再次输入密码的文本
        JLabel rePasswordText = new JLabel(new ImageIcon("puzzle\\image\\register\\再次输入密码.png"));
        ...
        //背景图片
        JLabel background = new JLabel(new ImageIcon("puzzle\\image\\register\\background.png"));
